...
public class InclusiveBoundsValidator<T extends Comparable<T>> implements Validator<T> {
    ...
    public static <T extends Comparable<T>> InclusiveBoundsValidator<T> newInclusiveUpperBoundValidator(T lowerBound) {
        return new InclusiveBoundsValidator<>(lowerBound, null);
    }

    public static <T extends Comparable<T>> InclusiveBoundsValidator<T> newInclusiveLowerBoundValidator(T upperBound) {
        return new InclusiveBoundsValidator<>(upperBound, null);
    }
