...
public class CommandManager {
     ...
     */
    public Command getCommandByName(String commandName, ResourceBundle messageBundle) throws NoSuchElementException {
        Command command = commands.get(commandName);
        if (command == null) {
            throw new NoSuchElementException(messageBundle.getString("error.cmdNotFound") + ": " + commandName);
        }
        return command;
    }
}
