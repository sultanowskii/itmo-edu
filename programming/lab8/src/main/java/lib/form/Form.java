...
public class Form {
     ...
     */
    public void fillObjectWithValidatedUserInput(Scanner scanner, Object object, ResourceBundle messageBundle) {
        for (Field<?> field : this.fields) {
            field.getParsedAndValidatedValueFromUserInput(scanner, 0, messageBundle);
            try {
                field.setValueToObject(object, messageBundle);
     ...
     */
    public String getStringifiedValueFromObject(Object object, int offsetLength, ResourceBundle messageBundle) {
        StringBuilder stringBuilder = new StringBuilder();
        for (Field<?> field : this.fields) {
            try {
                stringBuilder.append(field.getStringifiedValueFromObject(object, offsetLength + 1, messageBundle));
            } catch (NoSuchFieldException | IllegalAccessException e) {
                this.printWriter.println("Error occurred. This is not your fault. Error detail for developers: " + e + "");
            }
        }
