...
import server.file.ConfigReader;
...
public class Config {
    ...
    public static Config readFromfile(String configFilename, PrintWriter printWriter, ResourceBundle messageBundle) {
        ...
        try (
            ...
            try {
                return configReader.read(messageBundle);
