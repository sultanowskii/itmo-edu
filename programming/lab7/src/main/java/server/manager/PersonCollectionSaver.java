...
import server.file.CollectionManagerWriter;
...
public class PersonCollectionSaver implements CollectionSaver {
    ...
    public void saveCollectionToFile() throws IOException, InvalidCommandArgumentException {
        ...
        CollectionManagerWriter<PersonManager> personCollectionXMLWriter = new PersonCollectionXMLWriter(this.printWriter, outputStream);
